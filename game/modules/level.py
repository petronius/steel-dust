...
import modules.screen, modules.resources, modules.settings

class LevelAdministrator(modules.screen.Screen):
    def __init__(self, game):
        super(LevelAdministrator, self).__init__(game)
        self.game = game
        self.map_width, self.map_height = modules.settings.MAP_WIDTH, modules.settings.MAP_HEIGHT
